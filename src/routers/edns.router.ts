...
router.get(
  ...
  EdnsController.getReverseAddressRecord,
  errorHandler
);
router.get(
  "/record/:fqdn/address/list",
  EdnsController.getMultiCoinAddressList,
  errorHandler
);
router.get(
  "/record/:fqdn/address/:coin",
  EdnsController.getMultiCoinAddressRecord,
  errorHandler
);
router.get(
  "/record/:fqdn/address",
  EdnsController.getAddressRecord,
  errorHandler
);
router.get(
  "/record/:fqdn/nft/:chainId",
  EdnsController.getNftRecord,
  errorHandler
);
router.get(
  "/record/:fqdn/text/list",
  EdnsController.getTypedTextList,
  errorHandler
);
router.get(
  "/record/:fqdn/text/:typed",
  EdnsController.getTypedTextRecord,
  errorHandler
);
...
router.get(
  "/account/:account",
  EdnsController.getDomainsByAccount,
  errorHandler
);
