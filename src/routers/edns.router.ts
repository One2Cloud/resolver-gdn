...
router.get("/edns/queryWallet/:address", EdnsController.getWalletInfo,errorHandler)
router.get("/edns/queryDomain/:fqdn", EdnsController.getDomainDetails,errorHandler)
