...
export default class EdnsController {
  public static async queryEdnsAddress(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
  ...
  public static async queryEdnsNft(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
  ...
  public static async queryEdnsText(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
  ...
  public static async queryEdnsDomain(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
  ...
  public static async queryEdnsTypeText(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
