...
interface ILegacyBaseRegistrarInterface extends ethers.utils.Interface {
  functions: {
    ...
    "nameExpiry(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "nameExpiry", data: BytesLike): Result;
...
export class ILegacyBaseRegistrar extends BaseContract {
  ...
  nameExpiry(id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
