...
export default class EdnsController {
  ...
  public static async getReverseAddressRecord(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      const options = extract(req);
      const service = new EdnsService();
      const output = await service.getReverseAddressRecord(
        { address },
        options
      );
      const response: IGeneralResponse<typeof output> = {
  ...
  public static async getAddressRecord(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      const options = extract(req);
      const service = new EdnsService();
      const [output, ttl] = await Promise.all([
        service.getAddressRecord({ fqdn }, options),
        service.getTtl(fqdn, options),
      ]);
      const response: IGeneralResponse<typeof output> = {
        status: 200,
        success: true,
  ...
  public static async getMultiCoinAddressRecord(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      const service = new EdnsService();
      const [output, ttl] = await Promise.all([
        service.getMultiCoinAddressRecord({ fqdn, coin }, options),
        service.getTtl(fqdn, options),
      ]);
      const response: IGeneralResponse<typeof output> = {
        status: 200,
  ...
  public static async getTextRecord(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      const service = new EdnsService();
      const [output, ttl] = await Promise.all([
        service.getTextRecord({ fqdn }, options),
        service.getTtl(fqdn, options),
      ]);
      const response: IGeneralResponse<typeof output> = {
        status: 200,
  ...
  public static async getTypedTextRecord(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      const service = new EdnsService();
      const [output, ttl] = await Promise.all([
        service.getTypedTextRecord({ fqdn, typed }, options),
        service.getTtl(fqdn, options),
      ]);
      const response: IGeneralResponse<typeof output> = {
        status: 200,
  ...
  public static async getNftRecord(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      const service = new EdnsService();
      const [output, ttl] = await Promise.all([
        service.getNftRecord({ fqdn, chainId }, options),
        service.getTtl(fqdn, options),
      ]);
      const response: IGeneralResponse<typeof output> = {
        status: 200,
  ...
  public static async getDomain(
    ...
    try {
      ...
      const service = new EdnsService();
      const [output, ttl] = await Promise.all([
        service.getDomain(fqdn, options),
        service.getTtl(fqdn, options),
      ]);
      const response: IGeneralResponse<typeof output> = {
        status: 200,
  ...
  public static async getExpiry(
    ...
    try {
      ...
      const service = new EdnsService();
      const [output, ttl] = await Promise.all([
        service.getExpiry(fqdn, options),
        service.getTtl(fqdn, options),
      ]);
      const response: IGeneralResponse<typeof output> = {
        status: 200,
  ...
  public static async getDomainsByAccount(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
  ...
  public static async getMultiCoinAddressList(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      const service = new EdnsService();
      const [output, ttl] = await Promise.all([
        service.getMultiCoinAddressList(fqdn, options),
        service.getTtl(fqdn, options),
      ]);
      const response: IGeneralResponse<typeof output> = {
        status: 200,
  ...
  public static async getTypedTextList(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      const service = new EdnsService();
      const [output, ttl] = await Promise.all([
        service.getTypedTextList(fqdn, options),
        service.getTtl(fqdn, options),
      ]);
      const response: IGeneralResponse<typeof output> = {
        status: 200,
